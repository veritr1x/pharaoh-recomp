...
recovered by hand. No such set exists for "Pharaoh.exe", so this script imports
...
into ignored analysis/decompiled/Pharaoh.exe with the kit's ExportProgram.java.
Run tools/setup.py --install ... --link-only first. The export of a 1.4 MB
...
def main():
    ...
    listings = cfg["listings_path"]            # analysis/decompiled/Pharaoh.exe
